  ...
  return (
    <div className="flex px-3 lg:px-16 relative items-center border border-zinc-200 justify-evenly gap-4 bg-light rounded-xl">
      <div className="space-y-4 w-full my-5">
        <h4 className="font-bold text-dark text-base md:text-3xl leading-[20px] md:leading-[40px] w-[100%] lg:w-full">
          {text}
        </h4>
        <Link
          href={link}
          className="rounded-full text-xs  bg-dark py-2 md:py-3 md:px-4 px-3 text-white  cursor-pointer"
        >
          Buy Now
        </Link>
      </div>
